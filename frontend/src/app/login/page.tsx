  ...
  const renderGoogleButton = useCallback((): void => {
    ...
    try {
      ...
      window.google.accounts.id.renderButton(googleButtonRef.current, {
        theme: "outline", size: "large", width: googleButtonRef.current.clientWidth || 380, text: "continue_with",
      });
    } catch (e) {
          ...
          <div className="space-y-3 relative z-10">
            <div className="rounded-2xl border-2 border-[#e8dede] bg-white p-1 shadow-[0_3px_0_0_#e8dede]">
              ...
              <button
                ...
                className="w-full py-2.5 px-4 rounded-xl flex items-center justify-center gap-3 bg-white hover:bg-stone-50 border border-stone-200 text-stone-800 text-xs font-bold transition-all shadow-2xs hover:scale-[1.01] active:scale-[0.99] cursor-pointer"
              >
